...
bool VKTriangleApp::checkValidationLayerSupport() 
{
    uint32_t layerCount;
...
void VKTriangleApp::createInstance()
{
...
QueueFamilyIndices VKTriangleApp::findQueueFamilies(VkPhysicalDevice device)
{
...
bool VKTriangleApp::checkDeviceExtensionSupport(VkPhysicalDevice device)
{
...
SwapChainSupportDetails VKTriangleApp::querySwapChainSupport(
...
bool VKTriangleApp::isDeviceSuitable(VkPhysicalDevice device) {
...
void VKTriangleApp::pickPhysicalDevice()
{
...
void VKTriangleApp::createLogicalDevicesAndQueue()
{
...
void VKTriangleApp::establishDisplaySizeIdentity() {
...
void VKTriangleApp::createSwapChain()
{
...
void VKTriangleApp::createImageViews() {
...
void VKTriangleApp::createRenderPass() {
...
void VKTriangleApp::createDescriptorSetLayout() {
...
VkShaderModule VKTriangleApp::createShaderModule(const std::vector<uint8_t> &code) {
 ...
 */
void VKTriangleApp::createGraphicsPipeline() {
    auto vertShaderCode =
        LoadBinaryFileToVector("shaders/000_shader.vert.spv", assetManager);
    auto fragShaderCode =
        LoadBinaryFileToVector("shaders/000_shader.frag.spv", assetManager);
...
void VKTriangleApp::createFramebuffers() {
...
void VKTriangleApp::createCommandPool() {
...
void VKTriangleApp::createCommandBuffer() {
 ...
 */
void VKTriangleApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
 ...
 */
uint32_t VKTriangleApp::findMemoryType(uint32_t typeFilter,
...
void VKTriangleApp::createUniformBuffers() {
...
void VKTriangleApp::createDescriptorPool() {
...
void VKTriangleApp::createDescriptorSets() {
...
void VKTriangleApp::createSyncObjects() {
...
void VKTriangleApp::onOrientationChange()
{
    recreateSwapChain();
    orientationChanged = false;
}

void VKTriangleApp::recordCommandBuffer(VkCommandBuffer commandBuffer,
                                  uint32_t imageIndex) 
{
...
void VKTriangleApp::updateUniformBuffer(uint32_t currentImage) 
{
...
void VKTriangleApp::cleanupSwapChain()
{
...
void VKTriangleApp::recreateSwapChain()
{
    vkDeviceWaitIdle(device);
    cleanupSwapChain();
    createSwapChain();
...
void VKTriangleApp::reset(ANativeWindow *newWindow, AAssetManager *newManager)
{
